package com.android.cloud.speedup.ad.view;
...
public class SelfKPView extends RelativeLayout {
    ...
    public SelfKPView(final Context context) {
        ...
        my_image_view = (ImageView) findViewById(R.id.my_image_view);
//        my_image_view = findViewById(R.id.my_image_view);
    ...
    protected void onAttachedToWindow() {
        ...
        if (bean != null) {
//            GlideUtils.setMainAdapter(my_image_view, bean.getAd_kp());
//            my_image_view.setImageURI(Uri.parse(bean.getAd_kp()));
            Glide.with(context).load(Uri.parse(bean.getAd_kp()))
                    .apply(options).into(my_image_view);
            if (listener != null)
