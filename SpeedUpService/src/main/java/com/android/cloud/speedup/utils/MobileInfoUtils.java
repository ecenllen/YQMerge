...
/**
 * Created by yingyongduoduo on 2018/1/5.
 */
...
public class MobileInfoUtils {
    ...
    public static void jumpStartInterface(Context context) {
        // com.vivo.permissionmanager/.activity.SoftPermissionDetailActivity addf8ff pid=3715
...
//                componentName = ComponentName.unflattenFromString("com.vivo.permissionmanager/.activity.BgStartUpManagerActivity");
                ...
                componentName = ComponentName.unflattenFromString("com.meizu.safe/.permission_boot1.PermissionMainActivity");
            } else if (getMobileType().equals("OPPO")) { // OPPO R8205测试通过
                componentName = ComponentName.unflattenFromString("com.oppo.safe/.permission_boot1.startup.StartupAppListActivity");
